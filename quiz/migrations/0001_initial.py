    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maximum_marks', models.DecimalField(decimal_places=2, default=4, max_digits=6)),
                ('difficulty_level', models.CharField(choices=[('Easy', 'Easy'), ('Regular', 'Regular'), ('Hard', 'Hard')], default=1, max_length=100)),
